  ...
  <div>
    ...
    <div id="app">
      <div v-if="cartUIStatus === 'idle'" class="payment">
        ...
        <label>Name</label>
        <br />
        <input id="email" type="text" placeholder="type name." />
        <br />
        <br />
        <label>Country</label>
        <br />
        <input id="email" type="text" placeholder="type Country." />
        <br />
        <br />
        <label>City</label>
        <br />
        <input id="email" type="text" placeholder="type city." />
        <br />
        <br />
        <label>Pin</label>
        <br />
        <input id="email" type="text" placeholder="type pincode." />
        <br />
        <br />
        <label>Address</label>
        <br />
        <input id="email" type="text" placeholder="type address." />
        <br />
        ...
        <button class="pay-with-stripe button" href="/home">
          <a href="/"> Pay with credit card</a>
        </button>
      </div>
...
export default {
  ...
  methods: {
    setOrder() {
      console.log("setorder clale");
      this.order_comp = true;
    },
    pay() {
